// Complete portfolio data with all images from Curtis Williams' website

export const portfolioSections = {
  fashion: {
    title: "Fashion Photography",
    color: "red", // Red accent color
    images: [
      {
  ...
  covers: {
    ...
    color: "green", // Green accent color
    images: [
      {
  ...
  stillLife: {
    ...
    color: "brown", // Brown accent color
    images: [
      {
  ...
  artPhotoPainting: {
    ...
    color: "red", // Red accent color (artistic section)
    images: [
      {
